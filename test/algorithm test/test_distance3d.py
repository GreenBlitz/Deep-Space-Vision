...
def main():
    ...
    while True:
        ...
        thr = threshold_hatch_panel(frame)
        cv2.imshow('hello i is vision', thr)
        d = []
        circles = (
                threshold_hatch_panel + find_contours + sort_contours + filter_contours + contours_to_circles_sorted + filter_inner_circles)(
            frame)
        ...
        for i, c in enumerate(circles):
            ...
            d = HATCH_PANEL.location3d_by_params(camera, SQRT_PI * c[1], c[0])
