...
non_copy_dirs = [".git", "ml", "garbage_code_dont_delete_btw", "venv", ".idea", "main", "__pycache__"]
...
def main():
    global conn
    conn = pxssh.pxssh()
    if not conn.login(raw_input("enter ip address: "), raw_input("enter username: "), raw_input("enter password: ")):
        ...
        path = raw_input("enter path to project: ")
        path = path.replace("\\", '/')
